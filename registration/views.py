from .forms import UserCreationFormWhithEmail, ProfileForm, EmailForm
...
class EmailUpdate(UpdateView):
    ...
    def get_form(self, form_class=None):
        ...
        #Modificar en tiempo real
        form.fields['email'].widget = forms.EmailInput(attrs={'class':'form-control bm-2', 'placeholder':'Email'})
        return form
